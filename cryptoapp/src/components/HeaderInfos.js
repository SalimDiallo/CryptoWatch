    ...
    return (
        <div className="header-container">
            ...
            <ul className="title">
                ...
                <li>Crypto-monnais : {headerData.active_cryptocurrencies && headerData.active_cryptocurrencies.toLocaleString()}</li>
                <li>Markets : {headerData.markets && headerData.markets}</li>
            </ul>
            <ul className="infos-mkt">
                <li className='global-mkt'>Glogal Market Cap : {<PercentChange percent={headerData.market_cap_change_percentage_24h_usd}/>}</li>

...
const Table = ({coinsData}) => {
    ...
    const [rangeNumber,seRangeNumbert] = useState(100);
       ...
       <div className="table-container">
            ...
            <ul className="table-header">
                <div className="range-container">
                    <span>Top {" "} <input type="text" value={rangeNumber} onChange={(e)=>seRangeNumbert(e.target.value)}/></span>
                    <input type="range" min='1' max-="250" value={rangeNumber} onChange={(e)=>seRangeNumbert(e.target.value)}/>
                    <ToTop/>
                </div>
                {tableHeader.map((el)=>(
                    <li key={el}>

...
const TableLine = ({coin,index}) => {
        ...
        const priceFormater = (num)=>{
                ...
                maximumFractionDigits:7}).format(num);
                }else{
                    return num;
                }
            }
        ...
        const mktCapFormater = (num)=>{
            let number = String(num).split("").slice(0,-6);
        ...
        <div className="table-line">
            <div className="infos-container">
                ...
                <div className="infos">
                    ...
                    <a  href={"https://www.coingecko.com/fr/pi%C3%A8ces/" + coin.name.toLowerCase().replaceAll(" ","-")}  target="_blank" rel="noreferrer">
            ...
            <PercentChange percent={(coin.ath_change_percentage) > -3 ?  "aht" : coin.ath_change_percentage }/>
        </div>
    );
};
